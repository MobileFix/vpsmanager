...
if [ -d "/etc/squid3/" ]
then
	wget https://raw.githubusercontent.com/twossh/vpsmanager/master/scripts/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://raw.githubusercontent.com/twossh/vpsmanager/master/scripts/squid2.txt -O /tmp/sqd3
	...
	chmod +x /bin/torrent
	wget https://raw.githubusercontent.com/twossh/vpsmanager/master/scripts/addhost.sh -O /bin/addhost
	chmod +x /bin/addhost
	...
	wget https://raw.githubusercontent.com/twossh/vpsmanager/master/scripts/delhost.sh -O /bin/delhost
	chmod +x /bin/delhost
	...
	wget https://raw.githubusercontent.com/twossh/vpsmanager/master/scripts/ajuda.sh -O /bin/ajuda
	chmod +x /bin/ajuda
